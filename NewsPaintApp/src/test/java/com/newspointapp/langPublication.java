...
public class langPublication extends BasetestNewsPoint {
	
	@Test(priority=1)
	public void checkforlangPublication() throws Exception {
		
		try{
			
			scrollTo(newspointConstants.assamiyaText);
			clickName(newspointConstants.assamiyaText);
	       ...
	       // String ytodaydate1= "Mar 17";
	        ...
	        fw1.newLine();
	        fw1.write("**************List of Tops news Publication- ANN News which are not updated as per dates ::  "   + todaydate + " and " + ydate);
			fw1.close();
