...
public class tamilUpdatedNewsCheck extends BasetestNewsPoint{
	...
	public void hindiNewsCheck() throws Exception {
	     ...
	     try{
			...
			clickName(newspointConstants.tamitText);
	       ...
	       // String ytodaydate1= "Mar 17";
	        ...
	        fw1.newLine();
	        fw1.write("**************List of Tops news for TAMIL which are not updated as per dates ::  "   + todaydate + " and " + ydate);
			fw1.close();
			for(int i= 1; i<= 20 ; i++)
			{
